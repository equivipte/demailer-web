                                                ...
                                                <table class="header-row" width="378" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td class="header-row-td" width="378"
                                                            ...
                                                            valign="top" align="left"><spring:message
                                                                code="unsubscribe.request"/></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                    <spring:message code="unsubscribe.message"
                                                                    arguments="${emailToUnsubscribe}"/>
                                                    <br>
                                                    <br>
                                                    <spring:message code="unsubscribe.confirm.message"/>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                <div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
                                                    <a href="${pageContext.request.contextPath}/unsubscribe/unsubscribeEmailAddress?emailToUnsubscribe=${emailToUnsubscribe}&domainName=${domainName}"
                                                       style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">
                                                        &nbsp; <spring:message code="label.confirm"/> &nbsp;</a>
                                                </div>
                                                <table class="table-space" height="16"
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                                    ...
                                                    <tr>
                                                        <td width="100%" align="center" bgcolor="#f5f5f5"
                                                            ...
                                                            <a href="#"
                                                               style="color: #428bca; text-decoration: none; background-color: transparent;">&copy;
                                                                2014</a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
