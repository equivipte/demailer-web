...
public class ExcelToDTOConverter implements Serializable {
    ...
    public ContactDTO convertToContactDTO(Map<String, Integer> mapColumnIndex, ContactDTO contactDTO, Cell cell) {
        if (mapColumnIndex.get(HeaderImportSubscribe.EMAIL_ADDRESS.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.FIRST_NAME.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.LAST_NAME.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.COMPANY_NAME.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.ADDRESS1.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.ADDRESS2.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.ADDRESS3.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.COUNTRY.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.CITY.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.PHONE.getHeaderName()) != null) {
        ...
        if (mapColumnIndex.get(HeaderImportSubscribe.ZIP_CODE.getHeaderName()) != null) {
